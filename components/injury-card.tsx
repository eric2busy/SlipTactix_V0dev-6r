  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="text-white text-base font-semibold font-['Inter']">{injury.playerName}</div>
          <div className="text-[#AFAFAF] text-sm font-normal font-['Inter']">{injury.team}</div>
        </div>
        <div className="flex items-center gap-2">
          {getStatusIcon()}
          <span className={`text-sm font-bold font-['Inter'] ${getStatusColor()}`}>{injury.status}</span>
        </div>
      </div>

      {/* Injury Details */}
      <div>
        <div className="text-white text-base font-medium font-['Inter'] mb-1">{injury.injury}</div>
        <div className="text-[#AFAFAF] text-sm font-normal font-['Inter'] leading-relaxed">{injury.notes}</div>
      </div>

      {/* Updated Time */}
      <div className="flex items-center justify-between">
        <div className="text-[#AFAFAF] text-xs font-normal font-['Inter']">Updated: {injury.updated}</div>
        <button
