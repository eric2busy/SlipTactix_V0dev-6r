...
interface FavoritesListProps {
  ...
  onAddToPropsList: (prop: BetRecommendation) => void
}

export function FavoritesList({ props, onClose, onRemove, onAddToPropsList }: FavoritesListProps) {
  return (
    <motion.div
      initial={{ y: "100%" }}
      animate={{ y: 0 }}
    ...
    >
      <div className="flex justify-between items-center mb-4">
        <h3 className="font-bold text-lg">Saved Props ({props.length})</h3>
        <button
          onClick={onClose}
